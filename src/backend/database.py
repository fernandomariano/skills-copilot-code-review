...
initial_announcements = [
    {
        ...
        "message": "Welcome to the new school year! We're excited to have you back at Mergington High School. Please check the activities page for all the exciting extracurricular opportunities available this semester.",
        "start_date": None,
